...
SettingsGui_GetLayoutFixText() {
    ...
    text .= "Меняет каждую русскую букву на английскую с той же клавиши, а каждую английскую — на русскую.`r`n"
    text .= "Цифры, пробелы и пунктуация остаются без изменений. Словарь исключений продолжает действовать.`r`n"
